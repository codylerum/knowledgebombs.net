...
---
p. Just as a little experiment tonight I disabled my IPv4 stack on Vista and went entirely IPv6 native (no tunneling). Of course I got what I expected, a completly unusable system.
...
p. If IPv4 is going to run out in 2-3 years, the content providers have a long way to go.
