...
<script type="text/javascript">
 ...
 function convert() {
  ...
  if (ip.match(dotted)) ip = "0x" + d2h(dot2num(ip));
...
<form name="myForm">
 <div>
  <br />
  <b>Enter An IP Here to Convert to Hex:</b>&nbsp;<input type="text" id="ipnum" size="15" style="margin-bottom:0px;">&nbsp;&nbsp;<input type="button" value="Convert" onclick="convert();return false;">
  <br />
 </div>
</form>
